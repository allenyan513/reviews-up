...
1. Log in to [app.reviewsup.io](https://app.reviewsup.io)
...
If you encounter issues or have feature suggestions, feel free to [open an issue on GitHub](https://github.com/allenyan513/reviewsup-embed-example/issues) or contact us via the [official site](https://app.reviewsup.io).
